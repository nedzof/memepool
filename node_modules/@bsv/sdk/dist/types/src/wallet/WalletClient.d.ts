...
export default class WalletClient implements Wallet {
    substrate: 'auto' | Wallet;
    originator?: OriginatorDomainNameStringUnder250Bytes;
    constructor(substrate?: 'auto' | 'Cicada' | 'XDM' | 'window.CWI' | 'json-api' | Wallet, originator?: OriginatorDomainNameStringUnder250Bytes);
