...
class SHIPCast {
    ...
    constructor(topics, config) {
        ...
        this.requireAcknowledgmentFromAllHostsForTopics = requireAcknowledgmentFromAllHostsForTopics !== null && requireAcknowledgmentFromAllHostsForTopics !== void 0 ? requireAcknowledgmentFromAllHostsForTopics : [];
        this.requireAcknowledgmentFromAnyHostForTopics = requireAcknowledgmentFromAnyHostForTopics !== null && requireAcknowledgmentFromAnyHostForTopics !== void 0 ? requireAcknowledgmentFromAnyHostForTopics : 'all';
        this.requireAcknowledgmentFromSpecificHostsForTopics = requireAcknowledgmentFromSpecificHostsForTopics !== null && requireAcknowledgmentFromSpecificHostsForTopics !== void 0 ? requireAcknowledgmentFromSpecificHostsForTopics : {};
    }
    /**
    ...
    async broadcast(tx) {
        ...
        for (const result of successfulHosts) {
            ...
            for (const [topic, instructions] of Object.entries(steak)) {
                ...
                if (((outputsToAdmit === null || outputsToAdmit === void 0 ? void 0 : outputsToAdmit.length) > 0) || ((coinsToRetain === null || coinsToRetain === void 0 ? void 0 : coinsToRetain.length) > 0) || ((coinsRemoved === null || coinsRemoved === void 0 ? void 0 : coinsRemoved.length) > 0)) {
