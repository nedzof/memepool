...
class Transaction {
    ...
    static fromAtomicBEEF(beef) {
        ...
        if (prefix !== Beef_js_1.ATOMIC_BEEF) {
    ...
    static parseBEEFData(reader) {
        ...
        if (version !== Beef_js_1.BEEF_MAGIC) {
            throw new Error(`Invalid BEEF version. Expected ${Beef_js_1.BEEF_MAGIC}, received ${version}.`);
        }
        // Read the BUMPs
     ...
     *
     */
    async fee(modelOrFee = new SatoshisPerKilobyte_js_1.default(10), changeDistribution = 'equal') {
        this.cachedHash = undefined;
